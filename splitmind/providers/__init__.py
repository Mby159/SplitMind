...
from splitmind.providers.base import ProviderInfo, ProviderCapability, ProviderStatus
...
try:
    ...
    if openai_key:
        ...
        registry.register_class("openai", OpenAIProvider)
    ...
    if anthropic_key:
        ...
        registry.register_class("anthropic", AnthropicProvider)
